...
export const DEFAULT_CONFIG = {
  ...
  rules: {
    ...
    dangerousCalls: {
      ...
      cap: 5,
      patterns: [
        { pattern: '\\beval\\s*\\(', flags: 'g', points: 15, label: 'eval() call' },
        { pattern: '\\bnew Function\\s*\\(', flags: 'g', points: 12, label: 'Function constructor' },
        { pattern: '\\bos\\.system\\s*\\(', flags: 'g', points: 15, label: 'os.system() call' },
        { pattern: 'shell\\s*=\\s*True', flags: 'g', points: 12, label: 'subprocess shell=True' },
        { pattern: '\\bsubprocess\\.(call|run|Popen)\\b', flags: 'g', points: 6, label: 'subprocess invocation' },
        { pattern: '\\bpickle\\.loads?\\s*\\(', flags: 'g', points: 15, label: 'unsafe pickle deserialization' },
        { pattern: '\\byaml\\.load\\s*\\((?!.*Loader)', flags: 'g', points: 10, label: 'unsafe yaml.load' },
        { pattern: 'dangerouslySetInnerHTML', flags: 'g', points: 10, label: 'dangerouslySetInnerHTML' },
        { pattern: '\\.innerHTML\\s*=', flags: 'g', points: 8, label: 'innerHTML assignment' },
        { pattern: '\\bdocument\\.write\\s*\\(', flags: 'g', points: 8, label: 'document.write()' },
        { pattern: '(SELECT|INSERT|UPDATE|DELETE|DROP)\\b[^\'\"]*[\'\"]\\s*\\+', flags: 'gi', points: 12, label: 'SQL string concatenation' },
        { pattern: '\\b(md5|sha1)\\s*\\(', flags: 'gi', points: 5, label: 'weak hash (md5/sha1)' },
        { pattern: 'verify\\s*=\\s*False', flags: 'g', points: 12, label: 'TLS verification disabled' },
        { pattern: 'rejectUnauthorized\\s*:\\s*false', flags: 'g', points: 12, label: 'TLS rejectUnauthorized:false' },
      ],
    },
    smells: {
      enabled: true,

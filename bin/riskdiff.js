#!/usr/bin/env node
import { getDiffText, analyze, formatReport, THRESHOLDS } from '../src/index.js';
...
Options:
  ...
  --fail-on <level>   Exit 1 if risk meets/exceeds level (low|medium|high) [default: high]
...
const failOnRaw = failOnIdx !== -1 ? args[failOnIdx + 1] : 'high';
const failOnLevel = failOnRaw.toUpperCase();
